...
const phonesWrapper = document.body.querySelector('[data-container=phones]');
const filterSearch = document.body.querySelector('[data-filter=search]');
console.log(filterSearch);

filterSearch.addEventListener('input', function () {
    renderList(this.value.toLocaleLowerCase());
});
...
function renderList(query = '') {
    ...
    view += phones
        .filter((phone) => {
            const name = phone.name.toLocaleLowerCase();
